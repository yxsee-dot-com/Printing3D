...
#define CONFIG_OPTION_ENUM_DEFINE_STATIC_MAPS(NAME) \
	...
	static t_config_enum_values s_keys_map_PrinterTechnology{{"FFF", ptFFF},
	                                                         {"SLA", ptSLA}};
	CONFIG_OPTION_ENUM_DEFINE_STATIC_MAPS(PrinterTechnology)

	static const t_config_enum_values s_keys_map_GCodeFlavor{{"reprap",         gcfRepRapSprinter},
	...
	static const t_config_enum_values s_keys_map_AuthorizationType{{"key",  atKeyPassword},
	                                                               {"user", atUserPassword}};
	...
	static const t_config_enum_values s_keys_map_SLAPillarConnectionMode = {{"zigzag",  int(SLAPillarConnectionMode::zigzag)},
	...
	static inline const t_config_enum_values s_keys_map_SLASupportTreeType = {{"default",   int(sla::SupportTreeType::Default)},
	...
	static const t_config_enum_values s_keys_map_BrimType = {{"no_brim",         btNoBrim},
	...
	static const t_config_enum_values s_keys_map_ForwardCompatibilitySubstitutionRule = {{"disable",       ForwardCompatibilitySubstitutionRule::Disable},
	...
	static const t_config_enum_values s_keys_map_TowerSpeeds{{"layer1",  tsLayer1},
	                                                         {"layer2",  tsLayer2},
	                                                         {"layer3",  tsLayer3},
	                                                         {"layer4",  tsLayer4},
	                                                         {"layer5",  tsLayer5},
	...
	static const t_config_enum_values s_keys_map_TiltSpeeds{{"move120",   tsMove120},
	                                                        {"layer200",  tsLayer200},
	                                                        {"move300",   tsMove300},
	                                                        {"layer400",  tsLayer400},
	                                                        {"layer600",  tsLayer600},
	...
	void PrintConfigDef::init_common_params() {
		...
		//    def->tooltip = L("");
		def->set_enum<AuthorizationType>({std::pair<std::string_view, std::string_view>({"key", L("API key")}), std::pair<std::string_view, std::string_view>({"user", L("HTTP digest")})});
		def->mode = comAdvanced;
		def->cli = ConfigOptionDef::nocli;
	...
	void PrintConfigDef::init_fff_params() {
		...
		def->set_enum<ArcFittingType>({std::pair<std::string_view, std::string_view>({"disabled", "Disabled"}), std::pair<std::string_view, std::string_view>({"emit_center", "Enabled: G2/3 I J"})});
		def->mode = comAdvanced;
		...
		def->mode = comExpert;
		def->set_enum<TopOnePerimeterType>({std::pair<std::string_view, std::string_view>({"none", L("Disabled")}), std::pair<std::string_view, std::string_view>({"top", L("All top surfaces")}), std::pair<std::string_view, std::string_view>({"topmost", L("Topmost surface only")})});
		...
		def->set_enum<BrimType>({std::pair<std::string_view, std::string_view>({"no_brim", L("No brim")}), std::pair<std::string_view, std::string_view>({"outer_only", L("Outer brim only")}), std::pair<std::string_view, std::string_view>({"inner_only", L("Inner brim only")}), std::pair<std::string_view, std::string_view>({"outer_and_inner", L("Outer and inner brim")})});
		def->mode = comSimple;
		...
		def->tooltip = L("This end procedure is inserted at the end of the output file. "
		                 "Note that you can use placeholder variables for all Printing3D settings.");
		def->multiline = true;
		def->full_width = true;
		def->height = 12;
		def->mode = comExpert;
		...
		def->set_enum<InfillPattern>({std::pair<std::string_view, std::string_view>({"rectilinear", L("Rectilinear")}), std::pair<std::string_view, std::string_view>({"monotonic", L("Monotonic")}), std::pair<std::string_view, std::string_view>({"monotoniclines", L("Monotonic Lines")}), std::pair<std::string_view, std::string_view>({"alignedrectilinear", L("Aligned Rectilinear")}), std::pair<std::string_view, std::string_view>({"concentric", L("Concentric")}),
		                              std::pair<std::string_view, std::string_view>({"hilbertcurve", L("Hilbert Curve")}), std::pair<std::string_view, std::string_view>({"archimedeanchords", L("Archimedean Chords")}), std::pair<std::string_view, std::string_view>({"octagramspiral", L("Octagram Spiral")})});
		...
		def->set_enum_labels(ConfigOptionDef::GUIType::i_enum_open, {L("default"), "1", "2", "3", "4", "5"}); // override label for item 0
		...
		def->set_enum_values(ConfigOptionDef::GUIType::select_open, {"PLA", "PET", "ABS", "ASA", "FLEX", "HIPS", "EDGE", "NGEN", "PA", "NYLON", "PVA", "PC", "PP", "PEI", "PEEK", "PEKK", "POM", "PSU", "PVDF", "SCAFF"});
		def->mode = comAdvanced;
		...
		def->min = 0;
		def->max = 100;
		def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {std::pair<std::string_view, std::string_view>({"0", "0%"}), std::pair<std::string_view, std::string_view>({"5", "5%"}), std::pair<std::string_view, std::string_view>({"10", "10%"}), std::pair<std::string_view, std::string_view>({"15", "15%"}), std::pair<std::string_view, std::string_view>({"20", "20%"}), std::pair<std::string_view, std::string_view>({"25", "25%"}), std::pair<std::string_view, std::string_view>({"30", "30%"}),
		                                                             std::pair<std::string_view, std::string_view>({"40", "40%"}), std::pair<std::string_view, std::string_view>({"50", "50%"}), std::pair<std::string_view, std::string_view>({"60", "60%"}), std::pair<std::string_view, std::string_view>({"70", "70%"}), std::pair<std::string_view, std::string_view>({"80", "80%"}), std::pair<std::string_view, std::string_view>({"90", "90%"}),
		                                                             std::pair<std::string_view, std::string_view>({"100", "100%"})});
		...
		def->set_enum<InfillPattern>(
				{std::pair<std::string_view, std::string_view>({"rectilinear", L("Rectilinear")}), std::pair<std::string_view, std::string_view>({"alignedrectilinear", L("Aligned Rectilinear")}), std::pair<std::string_view, std::string_view>({"grid", L("Grid")}), std::pair<std::string_view, std::string_view>({"triangles", L("Triangles")}), std::pair<std::string_view, std::string_view>({"stars", L("Stars")}), std::pair<std::string_view, std::string_view>({"cubic", L("Cubic")}),
				 std::pair<std::string_view, std::string_view>({"line", L("Line")}), std::pair<std::string_view, std::string_view>({"concentric", L("Concentric")}), std::pair<std::string_view, std::string_view>({"honeycomb", L("Honeycomb")}), std::pair<std::string_view, std::string_view>({"3dhoneycomb", L("3D Honeycomb")}), std::pair<std::string_view, std::string_view>({"gyroid", L("Gyroid")}), std::pair<std::string_view, std::string_view>({"hilbertcurve", L("Hilbert Curve")}),
				 std::pair<std::string_view, std::string_view>({"archimedeanchords", L("Archimedean Chords")}), std::pair<std::string_view, std::string_view>({"octagramspiral", L("Octagram Spiral")}), std::pair<std::string_view, std::string_view>({"adaptivecubic", L("Adaptive Cubic")}), std::pair<std::string_view, std::string_view>({"supportcubic", L("Support Cubic")}), std::pair<std::string_view, std::string_view>({"lightning", L("Lightning")}),
				 std::pair<std::string_view, std::string_view>({"zigzag", L("Zig Zag")})});
		...
		def->set_enum<FuzzySkinType>({std::pair<std::string_view, std::string_view>({"none", L("None")}), std::pair<std::string_view, std::string_view>({"external", L("Outside walls")}), std::pair<std::string_view, std::string_view>({"all", L("All walls")})});
		def->mode = comSimple;
		...
		def->tooltip = L("Some G/M-code commands, including temperature control and others, are not universal. "
		                 ...
		                 "The \"No extrusion\" flavor prevents Printing3D from exporting any extrusion value at all.");
		def->set_enum<GCodeFlavor>(
				{std::pair<std::string_view, std::string_view>({"reprap", "RepRap/Sprinter"}), std::pair<std::string_view, std::string_view>({"reprapfirmware", "RepRapFirmware"}), std::pair<std::string_view, std::string_view>({"repetier", "Repetier"}), std::pair<std::string_view, std::string_view>({"teacup", "Teacup"}), std::pair<std::string_view, std::string_view>({"makerware", "MakerWare (MakerBot)"}), std::pair<std::string_view, std::string_view>({"marlin", "Marlin (legacy)"}),
				 std::pair<std::string_view, std::string_view>({"marlin2", "Marlin 2"}), std::pair<std::string_view, std::string_view>({"klipper", "Klipper"}), std::pair<std::string_view, std::string_view>({"sailfish", "Sailfish (MakerBot)"}), std::pair<std::string_view, std::string_view>({"mach3", "Mach3/LinuxCNC"}), std::pair<std::string_view, std::string_view>({"machinekit", "Machinekit"}), std::pair<std::string_view, std::string_view>({"smoothie", "Smoothie"}),
				 std::pair<std::string_view, std::string_view>({"no-extrusion", L("No extrusion")})});
		def->mode = comExpert;
		...
		def->set_enum<LabelObjectsStyle>({std::pair<std::string_view, std::string_view>({"disabled", L("Disabled")}), std::pair<std::string_view, std::string_view>({"octoprint", L("OctoPrint comments")}), std::pair<std::string_view, std::string_view>({"firmware", L("Firmware-specific")})});
		def->mode = comAdvanced;
		...
		def->tooltip = L("Connect an infill line to an internal perimeter with a short segment of an additional perimeter. "
		                 ...
		                 "Printing3D tries to connect two close infill lines to a short perimeter segment. If no such perimeter segment "
		...
		def->max_literal = 1000;
		def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {std::pair<std::string_view, std::string_view>({"0", L("0 (no open anchors)")}), std::pair<std::string_view, std::string_view>({"1", L("1 mm")}), std::pair<std::string_view, std::string_view>({"2", L("2 mm")}), std::pair<std::string_view, std::string_view>({"5", L("5 mm")}), std::pair<std::string_view, std::string_view>({"10", L("10 mm")}), std::pair<std::string_view, std::string_view>({"1000", L("1000 (unlimited)")})});
		def->mode = comAdvanced;
		...
		def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {std::pair<std::string_view, std::string_view>({"0", L("0 (not anchored)")}), std::pair<std::string_view, std::string_view>({"1", L("1 mm")}), std::pair<std::string_view, std::string_view>({"2", L("2 mm")}), std::pair<std::string_view, std::string_view>({"5", L("5 mm")}), std::pair<std::string_view, std::string_view>({"10", L("10 mm")}), std::pair<std::string_view, std::string_view>({"1000", L("1000 (unlimited)")})});
		...
		def->set_enum<IroningType>({std::pair<std::string_view, std::string_view>({"top", L("All top surfaces")}), std::pair<std::string_view, std::string_view>({"topmost", L("Topmost surface only")}), std::pair<std::string_view, std::string_view>({"solid", L("All solid surfaces")})});
		def->mode = comAdvanced;
		...
		def->set_enum<MachineLimitsUsage>({std::pair<std::string_view, std::string_view>({"emit_to_gcode", L("Emit to G-code")}), std::pair<std::string_view, std::string_view>({"time_estimate_only", L("Use for time estimate")}), std::pair<std::string_view, std::string_view>({"ignore", L("Ignore")})});
		def->mode = comAdvanced;
		...
		def->set_enum<PrintHostType>({std::pair<std::string_view, std::string_view>({"prusalink", "PrusaLink"}), std::pair<std::string_view, std::string_view>({"prusaconnect", "PrusaConnect"}), std::pair<std::string_view, std::string_view>({"octoprint", "OctoPrint"}), std::pair<std::string_view, std::string_view>({"moonraker", "Klipper (via Moonraker)"}), std::pair<std::string_view, std::string_view>({"duet", "Duet"}), std::pair<std::string_view, std::string_view>({"flashair", "FlashAir"}),
		                              std::pair<std::string_view, std::string_view>({"astrobox", "AstroBox"}), std::pair<std::string_view, std::string_view>({"repetier", "Repetier"}), std::pair<std::string_view, std::string_view>({"mks", "MKS"})});
		def->mode = comAdvanced;
		def->cli = ConfigOptionDef::nocli;
		...
		def->tooltip = L("If enabled, Printing3D detects obstacles along the travel path and makes the slope steeper "
		...
		def->set_enum<SeamPosition>({std::pair<std::string_view, std::string_view>({"random", L("Random")}), std::pair<std::string_view, std::string_view>({"nearest", L("Nearest")}), std::pair<std::string_view, std::string_view>({"aligned", L("Aligned")}), std::pair<std::string_view, std::string_view>({"rear", L("Rear")})});
		def->mode = comSimple;
...
//    def->gui_type = ConfigOptionDef::GUIType::slider;
    ...
    def->set_default_value(new ConfigOptionFloat(30));
		...
		def->set_enum<DraftShield>({std::pair<std::string_view, std::string_view>({"disabled", L("Disabled")}), std::pair<std::string_view, std::string_view>({"limited", L("Limited")}), std::pair<std::string_view, std::string_view>({"enabled", L("Enabled")})});
		def->mode = comAdvanced;
		...
		def->tooltip = L("When enabled, Printing3D will check whether your custom Start G-Code contains G-codes to set "
		                 ...
		                 "placeholder variables for all Printing3D settings, so you can put "
		                 "a \"M109 S[first_layer_temperature]\" command wherever you want.\n"
		                 "If your custom Start G-Code does NOT contain these G-codes, "
		                 "Printing3D will execute the Start G-Code after heated chamber was set to its temperature, "
		                 "bed reached its target temperature and extruder just started heating.\n\n"
		                 "When disabled, Printing3D will NOT emit commands to heat up extruder, bed or chamber, "
		...
		def->tooltip = L("This start procedure is inserted at the beginning, after any printer start gcode (and "
		                 ...
		                 "This is used to override settings for a specific filament. If Printing3D detects "
		                 ...
		                 "for all Printing3D settings, so you can put a \"M109 S[first_layer_temperature]\" command "
		...
		def->set_enum<SlicingMode>({std::pair<std::string_view, std::string_view>({"regular", L("Regular")}), std::pair<std::string_view, std::string_view>({"even_odd", L("Even-odd")}), std::pair<std::string_view, std::string_view>({"close_holes", L("Close holes")})});
		def->mode = comAdvanced;
		...
		def->sidetext = L("mm");
		//    def->min = 0;
		def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {std::pair<std::string_view, std::string_view>({"0", L("0 (soluble)")}), std::pair<std::string_view, std::string_view>({"0.1", L("0.1 (detachable)")}), std::pair<std::string_view, std::string_view>({"0.2", L("0.2 (detachable)")})});
		def->mode = comAdvanced;
		...
		def->set_enum_values(ConfigOptionDef::GUIType::f_enum_open, {
				...
				std::pair<std::string_view, std::string_view>({"0", L("Same as top")}), std::pair<std::string_view, std::string_view>({"0.1", "0.1"}), std::pair<std::string_view, std::string_view>({"0.2", "0.2"})});
		def->mode = comAdvanced;
		def->set_default_value(new ConfigOptionFloat(0));
		...
		def->sidetext = L("layers");
		def->min = 0;
		def->set_enum_values(ConfigOptionDef::GUIType::i_enum_open, {std::pair<std::string_view, std::string_view>({"0", L("0 (off)")}), std::pair<std::string_view, std::string_view>({"1", L("1 (light)")}), std::pair<std::string_view, std::string_view>({"2", L("2 (default)")}), std::pair<std::string_view, std::string_view>({"3", L("3 (heavy)")})});
		def->mode = comAdvanced;
		def->set_default_value(new ConfigOptionInt(3));
		...
		def->set_enum_values(ConfigOptionDef::GUIType::i_enum_open, {
				...
				std::pair<std::string_view, std::string_view>({"-1", L("Same as top")}), std::pair<std::string_view, std::string_view>({"0", L("0 (off)")}), std::pair<std::string_view, std::string_view>({"1", L("1 (light)")}), std::pair<std::string_view, std::string_view>({"2", L("2 (default)")}), std::pair<std::string_view, std::string_view>({"3", L("3 (heavy)")})});
		def->mode = comAdvanced;
		def->set_default_value(new ConfigOptionInt(-1));
		...
		def->set_enum<SupportMaterialPattern>({std::pair<std::string_view, std::string_view>({"rectilinear", L("Rectilinear")}), std::pair<std::string_view, std::string_view>({"rectilinear-grid", L("Rectilinear grid")}), std::pair<std::string_view, std::string_view>({"honeycomb", L("Honeycomb")})});
		def->mode = comAdvanced;
		...
		def->set_enum<SupportMaterialInterfacePattern>({std::pair<std::string_view, std::string_view>({"auto", L("Default")}), std::pair<std::string_view, std::string_view>({"rectilinear", L("Rectilinear")}), std::pair<std::string_view, std::string_view>({"concentric", L("Concentric")})});
		def->mode = comAdvanced;
		...
		def->tooltip = L("Style and shape of the support towers. Projecting the supports into a regular grid "
		                 ...
		                 "object scarring.");
		def->set_enum<SupportMaterialStyle>({std::pair<std::string_view, std::string_view>({"grid", L("Grid")}), std::pair<std::string_view, std::string_view>({"snug", L("Snug")}), std::pair<std::string_view, std::string_view>({"organic", L("Organic")})});
		def->mode = comAdvanced;
		...
		def->tooltip = L("This custom code is inserted before every toolchange. Placeholder variables for all Printing3D settings "
		                 "as well as {toolchange_z}, {previous_extruder} and {next_extruder} can be used. When a tool-changing command "
		                 "which changes to the correct extruder is included (such as T{next_extruder}), Printing3D will emit no other such command. "
		...
		def->set_default_value(new ConfigOptionFloats{0., 140., 140., 140., 140., 140., 0., 140., 140., 140., 140., 140., 0., 140., 140., 140., 140., 140., 0., 140., 140., 140., 140., 140., 0.});
		...
		def->set_enum<PerimeterGeneratorType>({std::pair<std::string_view, std::string_view>({"classic", L("Classic")}), std::pair<std::string_view, std::string_view>({"arachne", L("Arachne")})});
		def->mode = comAdvanced;
		...
		for (const char *opt_key: {
				// floats
				"retract_length", "retract_lift", "retract_lift_above", "retract_lift_below", "retract_speed", "travel_max_lift", "deretract_speed", "retract_restart_extra", "retract_before_travel", "retract_length_toolchange", "retract_restart_extra_toolchange",
				// bools
			...
			switch (def->type) {
				case coFloats   :
					...
					break;
				case coPercents :
					def->set_default_value(new ConfigOptionPercentsNullable(static_cast<const ConfigOptionPercents *>(it_opt->second.default_value.get())->values));
					break;
				case coBools    :
					def->set_default_value(new ConfigOptionBoolsNullable(static_cast<const ConfigOptionBools *   >(it_opt->second.default_value.get())->values));
					break;
				default:
					assert(false);
			}
	...
	void PrintConfigDef::init_extruder_option_keys() {
		...
		m_extruder_option_keys = {"nozzle_diameter", "min_layer_height", "max_layer_height", "extruder_offset", "retract_length", "retract_lift", "retract_lift_above", "retract_lift_below", "retract_speed", "deretract_speed", "retract_before_wipe", "retract_restart_extra", "retract_before_travel", "wipe", "travel_slope", "travel_max_lift", "travel_ramping_lift", "travel_lift_before_obstacle", "retract_layer_change", "retract_length_toolchange", "retract_restart_extra_toolchange",
		                          "extruder_colour", "default_filament_profile", "nozzle_high_flow"};

		m_extruder_retract_keys = {"deretract_speed", "retract_before_travel", "retract_before_wipe", "retract_layer_change", "retract_length", "retract_length_toolchange", "retract_lift", "retract_lift_above", "retract_lift_below", "retract_restart_extra", "retract_restart_extra_toolchange", "retract_speed", "travel_lift_before_obstacle", "travel_max_lift", "travel_ramping_lift", "travel_slope", "wipe"};
	...
	void PrintConfigDef::init_sla_support_params(const std::string &prefix) {
		...
		def->category = L("Supports");
		def->tooltip = L("Maximum weight of sub-trees that terminate on the model instead of the print bed. The weight is the sum of the lenghts of all "
		...
		def->set_enum<SLAPillarConnectionMode>(ConfigOptionEnum<SLAPillarConnectionMode>::get_enum_names(), {L("Zig-Zag"), L("Cross"), L("Dynamic")});
		def->mode = comAdvanced;
	...
	void PrintConfigDef::init_sla_params() {
		...
		def->set_enum<SLADisplayOrientation>({std::pair<std::string_view, std::string_view>({"landscape", L("Landscape")}), std::pair<std::string_view, std::string_view>({"portrait", L("Portrait")})});
		def->mode = comExpert;
		...
		def->gui_flags = "show_value";
		def->set_enum_values(ConfigOptionDef::GUIType::select_open, {"Tough", "Flexible", "Casting", "Dental", "Heat-resistant"});
		...
		def->set_enum<sla::SupportTreeType>(ConfigOptionEnum<sla::SupportTreeType>::get_enum_names(), {L("Default"),
		...
		def->set_enum<SLAMaterialSpeed>({std::pair<std::string_view, std::string_view>({"slow", L("Slow")}), std::pair<std::string_view, std::string_view>({"fast", L("Fast")}), std::pair<std::string_view, std::string_view>({"high_viscosity", L("High viscosity")})});
		def->mode = comAdvanced;
		...
		for (const char *opt_key: {
				// float
				"support_head_front_diameter", "branchingsupport_head_front_diameter", "support_head_penetration", "branchingsupport_head_penetration", "support_head_width", "branchingsupport_head_width", "support_pillar_diameter", "branchingsupport_pillar_diameter", "elefant_foot_compensation", "absolute_correction",
				// int
	...
	void PrintConfigDef::init_sla_tilt_params() {
		...
		def->mode = comExpert;
		def->sidetext = L("mm/s");
		def->set_enum<TowerSpeeds>({std::pair<std::string_view, std::string_view>({"layer1", "1"}), std::pair<std::string_view, std::string_view>({"layer2", "2"}), std::pair<std::string_view, std::string_view>({"layer3", "3"}), std::pair<std::string_view, std::string_view>({"layer4", "4"}), std::pair<std::string_view, std::string_view>({"layer5", "5"}), std::pair<std::string_view, std::string_view>({"layer8", "8"}), std::pair<std::string_view, std::string_view>({"layer11", "11"}),
		                            std::pair<std::string_view, std::string_view>({"layer14", "14"}), std::pair<std::string_view, std::string_view>({"layer18", "18"}), std::pair<std::string_view, std::string_view>({"layer22", "22"}), std::pair<std::string_view, std::string_view>({"layer24", "24"}),});
		def->set_default_value(new ConfigOptionEnums<TowerSpeeds>({tsLayer22, tsLayer22}));

		const std::initializer_list<std::pair<std::string_view, std::string_view>> tilt_speeds_il = {{"move120",   "120"},
		                                                                                             {"layer200",  "200"},
		                                                                                             {"move300",   "300"},
		                                                                                             {"layer400",  "400"},
		                                                                                             {"layer600",  "600"},
	...
	static std::set<std::string> PrintConfigDef_ignore = {"clip_multipart_objects", "duplicate_x", "duplicate_y", "gcode_arcs", "multiply_x", "multiply_y", "support_material_tool", "acceleration", "adjust_overhang_flow", "standby_temperature", "scale", "rotate", "duplicate", "duplicate_grid", "start_perimeters_at_concave_points", "start_perimeters_at_non_overhang", "randomize_start", "seal_position", "vibration_limit", "bed_size", "print_center", "g0", "threads", "pressure_advance",
	                                                      "wipe_tower_per_color_wipe", "serial_port", "serial_speed",
			// Introduced in some Printing3D 2.3.1 alpha, later renamed or removed.
			                                              "fuzzy_skin_perimeter_mode", "fuzzy_skin_shape",
			// Introduced in Printing3D 2.3.0-alpha2, later replaced by automatic calculation based on extrusion width.
			...
			// Disabled in 2.6.0-alpha6, this option is problematic
			                                              "infill_only_where_needed", "gcode_binary", // Introduced in 2.7.0-alpha1, removed in 2.7.1 (replaced by binary_gcode).
			                                              "wiping_volumes_extruders" // Removed in 2.7.3-alpha1.
	};

	void PrintConfigDef::handle_legacy(t_config_option_key &opt_key, std::string &value) {
		// handle legacy options
		if (opt_key == "extrusion_width_ratio" || opt_key == "bottom_layer_speed_ratio" || opt_key == "first_layer_height_ratio") {
			...
			if (value == "makerbot")
				...
				// the "new" marlin firmware flavor used to be called "marlinfirmware" for some time during Printing3D 2.4.0-alpha development.
				value = "marlin2";
			...
			value = oss.str();
		} else if ((opt_key == "perimeter_acceleration" && value == "25") || (opt_key == "infill_acceleration" && value == "50")) {
			...
			// Printing3D no more accepts skirt_height == -1 to print a draft shield to the top of the highest object.
			// A new "draft_shield" enum config value is used instead.
			opt_key = "draft_shield";
			value = "enabled";
		} else if (opt_key == "draft_shield" && (value == "1" || value == "0")) {
			// draft_shield used to be a bool, it was turned into an enum in Printing3D 2.4.0.
			...
			// and enum since Printing3D 2.6.2.
		...
		// In Printing3D 2.3.0-alpha0 the "monotonous" infill was introduced, which was later renamed to "monotonic".
	...
	const std::map<std::string, ConfigOptionFloats> tilt_options_floats_defs = {{"delay_before_exposure",  ConfigOptionFloats({3., 3., 0., 1., 3.5, 3.5, 0., 0.})},
	...
	const std::map<std::string, ConfigOptionInts> tilt_options_ints_defs = {{"tower_hop_height",       ConfigOptionInts({0, 0, 0, 0, 5, 5, 0, 0})},
	...
	const std::map<std::string, ConfigOptionBools> tilt_options_bools_defs = {{"use_tilt", ConfigOptionBools({true, true, true, true, true, true, false, false})},};

	const std::map<std::string, ConfigOptionEnums<TowerSpeeds>> tower_tilt_options_enums_defs = {{"tower_speed", ConfigOptionEnums<TowerSpeeds>({tsLayer22, tsLayer22, tsLayer22, tsLayer22, tsLayer2, tsLayer2, tsLayer1, tsLayer1})},};

	const std::map<std::string, ConfigOptionEnums<TiltSpeeds>> tilt_options_enums_defs = {{"tilt_down_initial_speed", ConfigOptionEnums<TiltSpeeds>({tsLayer1750, tsLayer1750, tsLayer1750, tsLayer1750, tsLayer800, tsLayer800, tsMove120, tsMove120})},
	...
	const std::map<std::string, ConfigOptionFloats> tilt_options_floats_sl1_defs = {{"delay_before_exposure",  ConfigOptionFloats({3., 3., 0., 1., 3.5, 3.5, 0., 0.})},
	                                                                                {"delay_after_exposure",   ConfigOptionFloats({0., 0., 0., 0., 0., 0., 0., 0.})},
	...
	const std::map<std::string, ConfigOptionInts> tilt_options_ints_sl1_defs = {{"tower_hop_height",       ConfigOptionInts({0, 0, 0, 0, 5, 5, 0, 0})},
	...
	const std::map<std::string, ConfigOptionBools> tilt_options_bools_sl1_defs = {{"use_tilt", ConfigOptionBools({true, true, true, true, true, true, false, false})},};

	const std::map<std::string, ConfigOptionEnums<TowerSpeeds>> tower_tilt_options_enums_sl1_defs = {{"tower_speed", ConfigOptionEnums<TowerSpeeds>({tsLayer22, tsLayer22, tsLayer22, tsLayer22, tsLayer2, tsLayer2, tsLayer1, tsLayer1})},};

	const std::map<std::string, ConfigOptionEnums<TiltSpeeds>> tilt_options_enums_sl1_defs = {{"tilt_down_initial_speed", ConfigOptionEnums<TiltSpeeds>({tsLayer400, tsLayer400, tsLayer400, tsLayer400, tsLayer600, tsLayer600, tsMove120, tsMove120})},
	...
	void handle_legacy_sla(DynamicPrintConfig &config) {
		...
		if (config.has("material_print_speed") && !config.has("tilt_down_offset_delay") // Config from old PS doesn't contain any of tilt options, so check it
				) {
	...
	std::string validate(const FullPrintConfig &cfg) {
		...
		if (cfg.use_firmware_retraction.value && cfg.gcode_flavor.value != gcfSmoothie && cfg.gcode_flavor.value != gcfRepRapSprinter && cfg.gcode_flavor.value != gcfRepRapFirmware && cfg.gcode_flavor.value != gcfMarlinLegacy && cfg.gcode_flavor.value != gcfMarlinFirmware && cfg.gcode_flavor.value != gcfMachinekit && cfg.gcode_flavor.value != gcfRepetier && cfg.gcode_flavor.value != gcfKlipper)
		...
		// --fill-density
		if (fabs(cfg.fill_density.value - 100.) < EPSILON && !print_config_def.get("top_fill_pattern")->has_enum_value(cfg.fill_pattern.serialize()))
		...
		// The following test was commented out after 482841b, see also https://github.com/prusa3d/Printing3D/pull/6743.
...
#define PRINT_CONFIG_CACHE_INITIALIZE(CLASSES_SEQ) \
	...
	PRINT_CONFIG_CACHE_INITIALIZE((PrintObjectConfig, PrintRegionConfig, MachineEnvelopeConfig, GCodeConfig, PrintConfig, FullPrintConfig, SLAMaterialConfig, SLAPrintConfig, SLAPrintObjectConfig, SLAPrinterConfig, SLAFullPrintConfig))
...
*/
	...
	CLIMiscConfigDef::CLIMiscConfigDef() {
		...
		def->tooltip = L("This version of Printing3D may not understand configurations produced by the newest Printing3D versions. "
		                 "For example, newer Printing3D may extend the list of supported firmware flavors. One may decide to "
		                 "bail out or to substitute an unknown value with a default silently or verbosely.");
		def->set_enum<ForwardCompatibilitySubstitutionRule>({std::pair<std::string_view, std::string_view>({"disable", L("Bail out on unknown configuration values")}), std::pair<std::string_view, std::string_view>({"enable", L("Enable reading unknown configuration values by verbosely substituting them with defaults.")}), std::pair<std::string_view, std::string_view>({"enable_silent", L("Enable reading unknown configuration values by silently substituting them with defaults.")})});
		...
		def->tooltip = L("If enabled, the command line arguments are sent to an existing instance of GUI Printing3D, "
		                 "or an existing Printing3D window is activated. "
...
*/
	...
	void DynamicPrintAndCLIConfig::handle_legacy(t_config_option_key &opt_key, std::string &value) const {
		if (cli_actions_config_def.options.find(opt_key) == cli_actions_config_def.options.end() && cli_profiles_sharing_config_def.options.find(opt_key) == cli_profiles_sharing_config_def.options.end() && cli_transform_config_def.options.find(opt_key) == cli_transform_config_def.options.end() && cli_misc_config_def.options.find(opt_key) == cli_misc_config_def.options.end()) {
	...
	ReadWriteSlicingStatesConfigDef::ReadWriteSlicingStatesConfigDef() {
		...
		def->tooltip = L("Position of the extruder at the beginning of the custom G-code block. If the custom G-code travels somewhere else, "
		                 "it should write to this variable so Printing3D knows where it travels from when it gets control back.");
		...
		def->tooltip = L("Retraction state at the beginning of the custom G-code block. If the custom G-code moves the extruder axis, "
		                 "it should write to this variable so Printing3D deretracts correctly when it gets control back.");
	...
	static std::map<t_custom_gcode_key, t_config_option_keys> s_CustomGcodeSpecificPlaceholders{{"start_filament_gcode", {"layer_num", "layer_z", "max_layer_z", "filament_extruder_id"}},
	...
	static bool is_XL_printer(const std::string &printer_notes) {
		return boost::algorithm::contains(printer_notes, "PRINTER_VENDOR_PRUSA3D") && boost::algorithm::contains(printer_notes, "PRINTER_MODEL_XL");
	}
