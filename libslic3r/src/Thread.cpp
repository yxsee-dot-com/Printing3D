...
#pragma pack(pop)
	...
	void name_tbb_thread_pool_threads_set_locale() {
		...
		// see GH issue #5661 Printing3D hangs on Linux when run with non standard task affinity
		...
		tbb::parallel_for(tbb::blocked_range<size_t>(0, nthreads, 1), [&nthreads_running, nthreads, &master_thread_id, &cv, &cv_m](const tbb::blocked_range<size_t> &range) {
