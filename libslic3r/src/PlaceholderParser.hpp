...
namespace Slic3r {
	...
	class PlaceholderParser {
		public:
			...
			std::string process(const std::string &templ, unsigned int current_extruder_id = 0, const DynamicConfig *config_override = nullptr, ContextData *context = nullptr) const { return this->process(templ, current_extruder_id, config_override, nullptr /* config_outputs */, context); }
