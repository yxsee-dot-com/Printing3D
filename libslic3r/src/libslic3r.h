...
// Profiles for the alpha are stored into the Printing3D-alpha directory to not mix with the current release.
...
#define GCODEVIEWER_APP_NAME "Printing3D G-code Viewer"
#define GCODEVIEWER_APP_KEY  "Printing3DGcodeViewer"
...
using coord_t = 
#if 1
// Saves around 32% RAM after slicing step, 6.7% after G-code export (tested on Printing3D 2.2.0 final).
    int32_t;
#else
