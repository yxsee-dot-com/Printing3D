...
namespace Slic3r {
	...
	enum class ThumbnailError : int {
		InvalidVal, OutOfRange, InvalidExt
	};
...
namespace Slic3r::GCodeThumbnails {
	...
	inline void generate_binary_thumbnails(ThumbnailsGeneratorCallback &thumbnail_cb, std::vector<bgcode::binarize::ThumbnailBlock> &out_thumbnails, const std::vector<std::pair<GCodeThumbnailsFormat, Vec2d>> &thumbnails_list, ThrowIfCanceledCallback throw_if_canceled) {
