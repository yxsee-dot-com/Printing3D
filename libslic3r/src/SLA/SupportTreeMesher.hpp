...
namespace Slic3r {
	namespace sla {
		...
		indexed_triangle_set sphere(double rho, Portion portion = make_portion(0., PI), double fa = (2. * PI / 360.));
		...
		// sp: starting point
		inline indexed_triangle_set cylinder(double r, double h, size_t steps = 45) {
