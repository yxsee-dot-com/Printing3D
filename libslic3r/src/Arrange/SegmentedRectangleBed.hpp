...
namespace Slic3r {
	namespace arr2 {
		...
		template<class T>
		struct IsSegmentedBed_ : public std::false_type {
		};
		...
		struct SegmentedRectangleBed {
			...
			SegmentedRectangleBed(const BoundingBox &bb, size_t segments_x, size_t segments_y, const RectPivots pivot = RectPivots::Center) : segments{segments_x, segments_y}, bb{bb}, pivot{pivot} {}
		...
		struct SegmentedRectangleBed<std::integral_constant<size_t, SegX>, std::integral_constant<size_t, SegY>> {
			BoundingBox bb;
			RectPivots pivot = RectPivots::Center;

			SegmentedRectangleBed() = default;

			explicit SegmentedRectangleBed(const BoundingBox &b, const RectPivots pivot = RectPivots::Center) : bb{b} {}
		...
		struct SegmentedRectangleBed<std::integral_constant<size_t, SegX>, std::integral_constant<size_t, SegY>, std::integral_constant<RectPivots, pivot>> {
			BoundingBox bb;
		...
		template<class... Args>
		struct IsSegmentedBed_<SegmentedRectangleBed<Args...>> : public std::true_type {
		};
