...
// Because of a crash in Printing3D 2.3.0/2.3.1 when showing an update notification with some locales, we don't want Printing3D 2.3.0/2.3.1
// to show this notification. On the other hand, we would like Printing3D 2.3.2 to show an update notification of the upcoming Printing3D 2.4.0.
// Thus we will let Printing3D 2.3.2 and couple of follow-up versions to download the version number from an alternate file until the Printing3D 2.3.0/2.3.1
...
static const std::string VERSION_CHECK_URL = "https://files.prusa3d.com/wp-content/uploads/repository/Printing3D-settings-master/live/Printing3D.version";
//static const std::string VERSION_CHECK_URL = "https://files.prusa3d.com/wp-content/uploads/repository/Printing3D-settings-master/live/Printing3D.version2";
...
static const std::string PROFILE_FOLDER_URL = "https://files.prusa3d.com/wp-content/uploads/repository/Printing3D-settings-master/live/";
...
std::string AppConfig::load(const std::string &path)
{
    ...
    try {
        ...
        if (!recovered) {
            // Report the initial error of parsing Printing3D.ini.
...
void AppConfig::save()
{
    ...
    // On Windows, the rename is likely NOT atomic, thus it may fail if Printing3D crashes on another thread in the meanwhile.
