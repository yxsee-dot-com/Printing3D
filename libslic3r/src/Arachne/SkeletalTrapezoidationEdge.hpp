	...
	class SkeletalTrapezoidationEdge {
		...
		public:
			...
			struct TransitionMiddle {
				...
				TransitionMiddle(coord_t pos, int lower_bead_count, coord_t feature_radius) : pos(pos), lower_bead_count(lower_bead_count), feature_radius(feature_radius) {}
			};
			...
			struct TransitionEnd {
				...
				TransitionEnd(coord_t pos, int lower_bead_count, bool is_lower_end) : pos(pos), lower_bead_count(lower_bead_count), is_lower_end(is_lower_end) {}
			};
