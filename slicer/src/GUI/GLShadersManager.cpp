...
namespace Slic3r {
	...
	std::pair<bool, std::string> GLShadersManager::init() {
		...
		auto append_shader = [this, &error](const std::string &name, const GLShaderProgram::ShaderFilenames &filenames, const std::initializer_list<std::string_view> &defines = {}) {
