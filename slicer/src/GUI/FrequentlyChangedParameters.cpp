	...
	namespace GUI {
		...
		FreqChangedParams::FreqChangedParams(wxWindow *parent) {
			...
			auto empty_widget = [this](wxWindow *parent) {
				...
				auto btn = new ScalableButton(parent, wxID_ANY, "mirroring_transparent", wxEmptyString, wxDefaultSize, wxDefaultPosition, wxBU_EXACTFIT | wxNO_BORDER | wxTRANSPARENT_WINDOW);
			...
			pad_def.set_enum_labels(ConfigOptionDef::GUIType::select_close, {L("None"), L("Below object"), L("Around object")});
