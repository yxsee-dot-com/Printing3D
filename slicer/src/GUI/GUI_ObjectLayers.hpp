...
namespace Slic3r {
	...
	namespace GUI {
		...
		enum EditorType {
			etUndef = 0, etMinZ = 1, etMaxZ = 2, etLayerHeight = 4,
		};
		...
		class LayerRangeEditor : public wxTextCtrl {
			...
			public:
				LayerRangeEditor(ObjectLayers *parent, const wxString &value = wxEmptyString, EditorType type = etUndef, std::function<void(EditorType)> set_focus_data_fn = [](EditorType) { ; },
