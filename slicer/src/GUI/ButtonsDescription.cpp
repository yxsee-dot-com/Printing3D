...
namespace Slic3r {
	namespace GUI {
		...
		static std::vector<std::pair<std::string, std::vector<std::string>>> MODE_PALETTES = {{L("Palette 1 (default)"), {"#00B000", "#FFDC00", "#E70000"}},
		...
		ModePaletteComboBox::ModePaletteComboBox(wxWindow *parent) : BitmapComboBox(parent, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0, nullptr, wxCB_READONLY) {
		...
		namespace GUI_Descriptions {
			...
			void FillSizerWithModeColorDescriptions(wxSizer *sizer, wxWindow *parent, std::vector<wxColourPickerCtrl **> clr_pickers, std::vector<wxColour> &mode_palette) {
			...
			Dialog::Dialog(wxWindow *parent, const std::vector<ButtonEntry> &entries) : wxDialog(parent, wxID_ANY, _(L("Buttons And Text Colors Description")), wxDefaultPosition, wxDefaultSize), m_entries(entries) {
