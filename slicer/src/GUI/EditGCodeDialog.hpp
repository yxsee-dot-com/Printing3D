...
namespace Slic3r {
	...
	namespace GUI {
		...
		enum class ParamType {
			Undef, Scalar, Vector, FilamentVector,
		};
		...
		class ParamsNode {
			...
			public:
				...
				ParamsNode(ParamsNode *parent, const wxString &sub_group_name, const std::string &icon_name);

				// parametre node
				ParamsNode(ParamsNode *parent, ParamType param_type, const std::string &param_key);
