	...
	namespace GUI {
		...
		class SubstitutionManager {
			...
			public:
				...
				void add_substitution(int substitution_id = -1, const std::string &plain_pattern = std::string(), const std::string &format = std::string(), const std::string &params = std::string(), const std::string &notes = std::string());
				void update_from_config();
				void delete_all();
				void edit_substitution(int substitution_id, int opt_pos, // option position insubstitution [0, 2]
		...
		class TabPrint : public Tab {
			public:
				TabPrint(wxBookCtrlBase *parent) : Tab(parent, _(L("Print Settings")), Slic3r::Preset::TYPE_PRINT) {}
				~TabPrint() {}
		...
		class TabFilament : public Tab {
			...
			public:
				TabFilament(wxBookCtrlBase *parent) : Tab(parent, _L("Filaments"), Slic3r::Preset::TYPE_FILAMENT) {}
				~TabFilament() {}
		...
		class TabPrinter : public Tab {
			...
			public:
				...
				TabPrinter(wxBookCtrlBase *parent) : Tab(parent, _L("Printers"), Slic3r::Preset::TYPE_PRINTER) {}
				~TabPrinter() {}
		...
		class TabSLAMaterial : public Tab {
			...
			public:
				TabSLAMaterial(wxBookCtrlBase *parent) : Tab(parent, _L("Materials"), Slic3r::Preset::TYPE_SLA_MATERIAL) {}
				~TabSLAMaterial() {}
		...
		class TabSLAPrint : public Tab {
				...
				void build_sla_support_params(const std::vector<SamePair<std::string>> &methods, const Slic3r::GUI::PageShp &page);

			public:
				TabSLAPrint(wxBookCtrlBase *parent) : Tab(parent, _(L("Print Settings")), Slic3r::Preset::TYPE_SLA_PRINT) {}
				~TabSLAPrint() {}
