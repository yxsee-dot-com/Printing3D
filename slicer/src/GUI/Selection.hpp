		...
		class Selection {
			public:
				...
				enum EType : unsigned char {
					Invalid, Empty, WipeTower, SingleModifier, MultipleModifier, SingleVolume, MultipleVolume, SingleFullObject, MultipleFullObject, SingleFullInstance, MultipleFullInstance, Mixed
				};
			...
			public:
				...
				enum class EUniformScaleRequiredReason : unsigned char {
					NotRequired, InstanceNotAxisAligned_World, VolumeNotAxisAligned_World, VolumeNotAxisAligned_Instance, MultipleSelection,
				};
			...
			public:
				enum class SyncRotationType {
					...
					NONE = 0, // Synchronize after rotation by an axis not parallel with Z.
					GENERAL = 1, // Synchronize after rotation reset.
					RESET = 2
				};
