...
namespace Slic3r {
	namespace GUI {
		...
		AboutDialogLogo::AboutDialogLogo(wxWindow *parent) : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize) {
			...
			this->logo = wxBitmap(from_u8(Slic3r::var("Printing3D_192px.png")), wxBITMAP_TYPE_PNG);
		...
		// CopyrightsDialog
		// -----------------------------------------
		CopyrightsDialog::CopyrightsDialog() : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, format_wxstr("%1% - %2%", wxGetApp().is_editor() ? SLIC3R_APP_NAME : GCODEVIEWER_APP_NAME, _L("Portions copyright")), wxDefaultPosition, wxDefaultSize, wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER) {
		...
		void CopyrightsDialog::fill_entries() {
			m_entries = {{"wxWidgets",                                      "2019 wxWidgets",                                       "https://www.wxwidgets.org/"},
			             ...
			             {"GLEW (The OpenGL Extension Wrangler Library)",   "2002 - 2007, Milan Ikits; "
			             ...
			             {"Miniz",                                          "2013-2014 RAD Game Tools and Valve Software; "
			                                                                "2010-2014 Rich Geldreich and Tenacious Software LLC",  "https://github.com/richgel999/miniz"},
			             ...
			             {"Real-Time DXT1/DXT5 C compression library",      "Based on original by fabian \"ryg\" giesen v1.04. "
			             ...
			             {"AppImage packaging for Linux using AppImageKit", "2004-2019 Simon Peter and contributors",               "https://appimage.org/"},
		...
		wxString CopyrightsDialog::get_html_text() {
			...
			wxString text = wxString::Format("<html>"
			                                 ...
			                                 "<font size=\"5\">%s.</font>"
			                                 "<br /><br />"
			                                 "<font size=\"3\">", bgr_clr_str, text_clr_str, text_clr_str, header_str);
		...
		AboutDialog::AboutDialog() : DPIDialog(static_cast<wxWindow *>(wxGetApp().mainframe), wxID_ANY, format_wxstr(_L("About %s"), wxGetApp().is_editor() ? SLIC3R_APP_NAME : GCODEVIEWER_APP_NAME), wxDefaultPosition, wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE | wxRESIZE_BORDER) {
			...
			m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_AUTO/*NEVER*/);
			{
				...
				const wxString based_on_str = _L("Printing3D is based on Prusa Research and Slic3r by Alessandro Ranellucci and the RepRap and Prusa Research");
				...
				const auto text = format_wxstr("<html>"
				                               "<body bgcolor= %1% link= %2%>"
				                               "<font color=%3%>"
				                               "%4% &copy; 2024-now 印象工作室. (https://www.yxsee.com) <br />"
				                               ...
				                               "</font>"
				                               "</body>"
				                               "</html>", bgr_clr_str, text_clr_str, text_clr_str, copyright_str, copyright_str, is_lecensed_str, license_str, based_on_str, contributors_str);
				m_html->SetPage(text);
