	...
	namespace GUI {
		...
		class BoostThreadWorker : public Worker, private Job::Ctl {
				...
				class WorkerMessage {
					public:
						enum MsgType {
							Empty, Status, Finalize, MainThreadCall
						};
			...
			public:
				...
				explicit BoostThreadWorker(std::shared_ptr<ProgressIndicator> pri, boost::thread::attributes &&attr, const char *name = "") : BoostThreadWorker{std::move(pri), attr, name} {}
