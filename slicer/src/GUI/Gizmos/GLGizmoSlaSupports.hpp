...
#include "GUI/GLSelectionRectangle.hpp"
			...
			private:
				...
				class CacheEntry {
					public:
						...
						CacheEntry(const sla::SupportPoint &point, bool sel = false, const Vec3f &norm = Vec3f::Zero()) : support_point(point), selected(sel), normal(norm) {}
