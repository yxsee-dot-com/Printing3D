...
#include "GUI/GLToolbar.hpp"
#include "GUI/Gizmos/GLGizmoBase.hpp"
		...
		class GLGizmosManager : public Slic3r::ObjectBase {
			public:
				...
				enum EType : unsigned char {
					...
					Move, Scale, Rotate, Flatten, Cut, Hollow, SlaSupports, FdmSupports, Seam, MmuSegmentation, Measure, Emboss, Svg, Simplify, Undefined
				};
