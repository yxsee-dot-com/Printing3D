...
#include "GUI/SurfaceDrag.hpp"
#include "GUI/I18N.hpp" // TODO: not needed
#include "GUI/TextLines.hpp"
#include "Utils/RaycastManager.hpp"
#include "Utils/EmbossStyleManager.hpp"
...
namespace Slic3r::GUI {
	class GLGizmoEmboss : public GLGizmoBase {
		...
		private:
			...
			template<typename T>
			bool rev_input_mm(const std::string &name, T &value, const T *default_value, const std::string &undo_tooltip, T step, T step_fast, const char *format, bool use_inch, const std::optional<float> &scale) const;
			...
			template<typename T>
			bool rev_input(const std::string &name, T &value, const T *default_value, const std::string &undo_tooltip, T step, T step_fast, const char *format, ImGuiInputTextFlags flags = 0) const;
			bool rev_checkbox(const std::string &name, bool &value, const bool *default_value, const std::string &undo_tooltip) const;
			bool rev_slider(const std::string &name, std::optional<float> &value, const std::optional<float> *default_value, const std::string &undo_tooltip, const MinMax<float> &min_max, const std::string &format, const wxString &tooltip) const;
			bool rev_slider(const std::string &name, float &value, const float *default_value, const std::string &undo_tooltip, const MinMax<float> &min_max, const std::string &format, const wxString &tooltip) const;
