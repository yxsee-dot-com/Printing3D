...
#include "libslic3r/src/Measure.hpp"
	...
	namespace GUI {
		...
		class GLGizmoMeasure : public GLGizmoBase {
				enum class EMode : unsigned char {
					FeatureSelection, PointSelection
				};
				...
				struct VolumeCacheItem {
					...
					bool operator==(const VolumeCacheItem &other) const {
						return this->object == other.object && this->instance == other.instance && this->volume == other.volume && this->world_trafo.isApprox(other.world_trafo);
					}
				};
