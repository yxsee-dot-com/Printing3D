...
namespace Slic3r {
	...
	namespace GUI {
		...
		enum FileType {
			FT_STL, FT_OBJ, FT_OBJECT, FT_STEP, FT_AMF, FT_3MF, FT_GCODE, FT_MODEL, FT_PROJECT, FT_FONTS, FT_GALLERY,
		...
		enum ConfigMenuIDs {
			//    ConfigMenuWizard,
			ConfigMenuSnapshots, ConfigMenuTakeSnapshot, //    ConfigMenuUpdateConf,
			//    ConfigMenuUpdateApp,
			ConfigMenuDesktopIntegration, ConfigMenuPreferences, ConfigMenuModeSimple, ConfigMenuModeAdvanced, ConfigMenuModeExpert, ConfigMenuLanguage, ConfigMenuFlashFirmware, ConfigMenuCnt, ConfigMenuWifiConfigFile
		};
		...
		// https://github.com/prusa3d/Printing3D/issues/4282#issuecomment-634676371
...
#define SUPPORTS_MARKUP
		...
		// see https://github.com/prusa3d/Printing3D/issues/12920
		...
		class GUI_App : public wxApp {
			...
			public:
				...
				std::string logo_name() const { return is_editor() ? "Printing3D" : "Printing3D-gcodeviewer"; }
				...
				// URL download - Printing3D gets system call to open prusaslicer:// URL which should contain address of download
