...
class SpinInput : public SpinInputBase {
	...
	public:
		SpinInput(wxWindow *parent, wxString text, wxString label = "", const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0, int min = 0, int max = 100, int initial = 0);

		void Create(wxWindow *parent, wxString text, wxString label = "", const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0, int min = 0, int max = 100, int initial = 0);
...
class SpinInputDouble : public SpinInputBase {
	...
	public:
		...
		SpinInputDouble(wxWindow *parent, wxString text, wxString label = "", const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0, double min = 0., double max = 100., double initial = 0., double inc = 1.);

		void Create(wxWindow *parent, wxString text, wxString label = "", const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0, double min = 0., double max = 100., double initial = 0., double inc = 1.);
