...
BEGIN_EVENT_TABLE(ComboBox, TextInput)
				...
				EVT_LEFT_DOWN(ComboBox::mouseDown) EVT_MOUSEWHEEL(ComboBox::mouseWheelMoved) EVT_KEY_DOWN(ComboBox::keyDown)
...
ComboBox::ComboBox(wxWindow *parent, wxWindowID id, const wxString &value, const wxPoint &pos, const wxSize &size, int n, const wxString choices[], long style) : drop(texts, icons) {
