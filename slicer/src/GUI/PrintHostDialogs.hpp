...
namespace Slic3r {
	...
	namespace GUI {
		...
		class PrintHostQueueDialog : public DPIDialog {
			...
			private:
				enum Column {
					COL_ID, COL_PROGRESS, COL_STATUS, COL_HOST, COL_SIZE, COL_FILENAME, COL_ERRORMSG
				};

				enum JobState {
					ST_NEW, ST_PROGRESS, ST_ERROR, ST_CANCELLING, ST_CANCELLED, ST_COMPLETED,
				};
				...
				enum UserDataType {
					UDT_SIZE = 1, UDT_POSITION = 2, UDT_COLS = 4
				};
