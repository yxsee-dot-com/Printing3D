...
class TopBarItemsCtrl : public wxControl {
		class Button : public wxPanel {
			...
			public:
				Button() {};
				Button(wxWindow *parent, const wxString &label, const std::string &icon_name = "", const int px_cnt = 16, wxSize size = wxDefaultSize);
		...
		class ButtonWithPopup : public Button {
			...
			public:
				ButtonWithPopup() {};
				ButtonWithPopup(wxWindow *parent, const wxString &label, const std::string &icon_name = "", const int px_cnt = 16, wxSize size = wxDefaultSize);
				ButtonWithPopup(wxWindow *parent, const std::string &icon_name, int icon_width = 20, int icon_height = 20);
	...
	public:
		TopBarItemsCtrl(wxWindow *parent, TopBarMenus *menus = nullptr, std::function<void()> cb_settings_btn = nullptr);
		~TopBarItemsCtrl() {}
...
class TopBar : public wxBookCtrlBase {
	public:
		TopBar(wxWindow *parent, wxWindowID winid = wxID_ANY, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0) {
			Init();
			Create(parent, winid, pos, size, style);
		}

		TopBar(wxWindow *parent, TopBarMenus *menus, std::function<void()> cb_settings_btn = nullptr) {
			Init();
		...
		bool Create(wxWindow *parent, wxWindowID winid = wxID_ANY, const wxPoint &pos = wxDefaultPosition, const wxSize &size = wxDefaultSize, long style = 0, TopBarMenus *menus = nullptr, std::function<void()> cb_settings_btn = nullptr) {
		...
		bool AddNewPage(wxWindow *page, const wxString &text, const std::string &bmp_name, bool bSelect = false) {
