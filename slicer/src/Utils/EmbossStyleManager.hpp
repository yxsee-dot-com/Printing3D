...
#include <libslic3r/src/EmbossShape.hpp>
...
namespace Slic3r::GUI::Emboss {
	...
	class StyleManager {
		...
		public:
			...
			/// </summary>
			/// <param name="app_config">Application configuration loaded from file "Printing3D.ini"
			...
			struct Style : public EmbossStyle {
				...
				bool operator==(const Style &other) const {
					return EmbossStyle::operator==(other) && projection == other.projection && is_approx(distance, other.distance) && is_approx(angle, other.angle);
				}
