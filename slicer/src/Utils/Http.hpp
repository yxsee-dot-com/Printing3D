	...
	class Http : public std::enable_shared_from_this<Http> {
		...
		public:
			struct Progress {
				...
				Progress(size_t dltotal, size_t dlnow, size_t ultotal, size_t ulnow, const std::string &buffer) : dltotal(dltotal), dlnow(dlnow), ultotal(ultotal), ulnow(ulnow), buffer(buffer) {}
			};
