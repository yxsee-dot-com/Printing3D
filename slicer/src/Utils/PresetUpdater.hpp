...
#include "GUI/PresetArchiveDatabase.hpp"
...
namespace Slic3r {
	...
	class PresetUpdater {
		public:
			...
			enum UpdateResult {
				R_NOOP, R_INCOMPAT_EXIT, R_INCOMPAT_CONFIGURED, R_UPDATE_INSTALLED, R_UPDATE_REJECT, R_UPDATE_NOTIFICATION, R_ALL_CANCELED
			};
